...
use App\Models\Harilibur; // Pastikan untuk mengimpor model Harilibur
...
class HariliburController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('harilibur.create', compact('departemen'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        $departemen = DB::table('departemen')->orderBy('kode_dept')->get();
        return view('harilibur.edit', compact('departemen','harilibur'));
    }
    ...
    {
        $delete = DB::table('harilibur')->where('kode_libur', $kode_libur)->delete();
        if($delete){
    ...
    public function setkaryawanlibur($kode_libur)
    {
        $harilibur = DB::table('harilibur')
            ->join('departemen','harilibur.kode_dept','=','departemen.kode_dept')
    ...
    public function getsetlistkaryawanlibur($kode_libur)
    {
        ...
        $karyawan = DB::table('karyawan')
            ...
            ->where('kode_dept', $harilibur->kode_dept)
    ...
    {
        try {
            $cek = DB::table('harilibur_detail')->where('kode_libur',$request->kode_libur)->where('nik',$request->nik)->count();
            if($cek>0){
                return 1;
            }
    ...
    public function getkaryawanlibur($kode_libur)
    {
        $karyawanlibur = DB::table('harilibur_detail')
            ...
            return view('harilibur.getkaryawanlibur', compact('karyawanlibur'));
    }
