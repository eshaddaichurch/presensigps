    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$harilibur->kode_libur}}" id="kode_libur" class="form-control" placeholder="Auto" name="kode_libur" disabled>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$harilibur->tanggal_libur}}" id="tanggal_libur" class="form-control" placeholder="Tanggal Libur" name="tanggal_libur" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row mb-3">
            ...
            <div class="form-group">
                <select name="kode_dept" id="kode_dept" class="form-select">
                    ...
                    @foreach ($departemen as $d)
                        <option {{ $harilibur->kode_dept == $d->kode_dept ? 'selected' : ''}} 
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$harilibur->keterangan}}" id="keterangan" class="form-control" placeholder="Keterangan" name="keterangan" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row mt-2">
